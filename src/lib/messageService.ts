...
export class MessageService {
  ...
  async markMessagesAsRead(conversationId: string): Promise<boolean> {
    try {
      ...
      if (conversationId.startsWith('delivery-')) {
        ...
        // Para los chats de delivery, actualizaremos solo el estado en memoria
        // Ya que estos chats se manejan diferente
        return true;
      }
      ...
      // Resetear el contador de no leídos para el usuario actual
  ...
  // Crear una nueva conversación con un usuario o empresa
          ...
          deliveryConversations.push({
            ...
            participants: [
              ...
              companyInfo || {
                ...
                name: quote.deliveryPerson || 'Repartidor',
                role: 'seller'
              }
            ],
            ...
            lastMessage: lastMessage ? {
              ...
              senderName: lastMessage.sender === 'user' ? (user.displayName || 'Cliente') : (quote.deliveryPerson || 'Repartidor'),
            ...
            requestId: quote.requestId || quote.id,
            quoteId: quote.id
          });
        }
      }
