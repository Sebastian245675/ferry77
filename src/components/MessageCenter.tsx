  ...
  const ChatList = () => (
    <div className="h-full flex flex-col">
      <div className="p-4 border-b">
        <h2 className="text-lg font-semibold text-gray-900">Chat con delivery</h2>
        <p className="text-sm text-gray-600">Mensajes con los repartidores de tus pedidos en progreso</p>
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="p-4 text-center text-gray-500">
            {searchQuery
              ? "No se encontraron conversaciones relacionadas con pedidos"
              : "No se encontraron chats activos. Los chats de tus pedidos en progreso aparecerán aquí."}
          </div>
        ) : (
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-600">
                      {selectedConversation.type === 'delivery' ? 'Chat de entrega' : 'Chat'}
                    </p>
                  </div>
                </>
              )}
        ...
        <div className="p-4 border-t bg-white">
          <div className="flex items-center space-x-2">
            <Input
              ...
              className="flex-1"
            />
            <Button onClick={sendMessage} disabled={!message.trim() || !selectedChat || loadingMessages}>
              <Send size={18} />
            </Button>
          </div>
        </div>
          ...
          <div className={`w-full md:w-2/3 ${selectedChat ? 'block' : 'hidden md:flex md:items-center md:justify-center'}`}>
            {selectedChat ? (
              ...
              <div className="text-center p-8 max-w-md">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">Tus mensajes</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Selecciona una conversación o comienza una nueva para chatear con empresas proveedoras.
                </p>
              </div>
            )}
          </div>
